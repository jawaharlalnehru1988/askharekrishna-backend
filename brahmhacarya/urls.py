...
from .views import BrahmhacaryaArticleViewSet, BrahmhacaryaRegistrationCreateAPIView, BrahmhacaryaBulkAPIView, BrahmhacaryaUserScoreCreateAPIView
...
urlpatterns = [
    ...
    path('v1/brahmhacarya/score/', BrahmhacaryaUserScoreCreateAPIView.as_view(), name='brahmhacarya-score'),
